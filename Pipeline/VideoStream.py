...
if __name__ == '__main__':
	vStream = VideoStream('https://sts003.feratel.co.at/streams/stsstore001/1/15111_63a184d4-2098Vid.mp4?dcsdesign=feratel4').start()
	while True:
		frame = vStream.read()
		cv2.imwrite('test.png',frame)
		print("Frame saved. Sleeping 10s")
		import time; time.sleep(10)

		# To covert to PIL Image to use in YOLO
